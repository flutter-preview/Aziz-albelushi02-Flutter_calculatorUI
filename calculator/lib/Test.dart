...
class ButtonValuePrinter extends StatefulWidget {
  const ButtonValuePrinter({super.key});

  @override
  _ButtonValuePrinterState createState() => _ButtonValuePrinterState();
}

class _ButtonValuePrinterState extends State<ButtonValuePrinter> {
  String printedValue = '';
